...
namespace Server.Utility
{
    ...
    public class Fiber
    {
        ...
        public Task<T> EnqueueAsync<T>(Func<Task<T>> f, bool exclusive = true)
        {
        ...
        /// <param name="f">The function that should be awaited</param>
        /// <param name="exclusive">Should the function run exclusively?</param>
        public Task EnqueueAsync(Func<Task> f, bool exclusive = true)
        {
        ...
        /// <param name="exclusive">Should the function run exclusively?</param>
        public Task ScheduleAsync(Func<Task> f, TimeSpan waitTime, bool exclusive = true)
        {
        ...
        /// <param name="waitTime">How long to wait before awaiting the function</param>
        /// <param name="exclusive">Should the function run exclusively?</param>
        public Task<T> ScheduleAsync<T>(Func<Task<T>> f, TimeSpan waitTime, bool exclusive = true)
        {
